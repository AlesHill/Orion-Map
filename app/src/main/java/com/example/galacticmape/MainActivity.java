...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // По нажатию на кнопку "Начать" скрываем стартовый экран и показываем главное меню
        ...
        // Логика кнопки "Млечный Путь" — открытие новой активности с картой
        milkyWayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent); // Переход на карту
            }
        });

        // Логика кнопки "Магелланово Облако" — показываем заглушку

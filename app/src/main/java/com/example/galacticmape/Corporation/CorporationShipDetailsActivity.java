...
public class CorporationShipDetailsActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corporation_ship);
        ...
        Log.d("OwnerShipDetailActivity", "corporationId: " + corporationId);

        if (corporationId == null) {
            Log.e("OwnerShipDetailActivity", "corporationId is null. Проверьте, передается ли параметр правильно.");
            return;
        }
    ...
    private void loadShipsForState(String corporationId) {
        try {
            ...
            if (shipsForState.length() == 0) {
                ...
                Log.d("OwnerShipDetailActivity", "Найдено " + shipsForState.length() + " кораблей для государства " + corporationId);
            }
